...
>>> print("The root of their difference is", math.sqrt(y-x))
The root of their difference is 1.4142135623730951
>>> print("The root of their difference is %.2f", math.sqrt(y-x))
The root of their difference is %.2f 1.4142135623730951
>>> print("The root of their difference is %.2f", %math.sqrt(y-x))
SyntaxError: invalid syntax
>>> print("The root of their difference is %.2f", math.%sqrt(y-x))
SyntaxError: invalid syntax
